<div class="px-10">
    ...
    <div class="h-screen overflow-y-scroll no-scrollbar p-6">
        <form action="/savePage/{{ $id }}" method='post'>
            @csrf
            ...
            <script>
                function store() {
                    ...
                    document.getElementById('html').value = JSON.stringify(editor.store().html);
                    document.getElementById('css').value = JSON.stringify(editor.store().css);
...
<script>
    ...
    container: '#gjs',
        ...
        panels: {
            defaults: [{
                ...
                buttons: [{
                    id: 'device-desktop',
                    label: '<img src="../Icons/monitor.svg" alt="">',
                    command: 'set-device-desktop',
                    active: true,
                    togglable: false,
                }, {
                    id: 'device-mobile',
                    label: '<img src="../Icons/mobile.svg" alt="">',
        ...
        blockManager: {
            ...
            blocks: [{
                ...
                label: '<img src="../Icons/web-layout.svg" alt="">',
                attributes: {
          ...
          <div>This is just a Lorem text: Lorem ipsum dolor sit amet</div>
                ...
                id: 'text',
                label: '<img src="../Icons/text.svg" alt="">',
                content: '<div data-gjs-type="text">Insert your text here</div>',
            }, {
                id: 'image',
                label: '<img src="../Icons/image.svg" alt="">',
    ...
    editor.Panels.addPanel({
        ...
        buttons: [{
            ...
            label: '<img src="../Icons/border.svg" alt="">',
            command: 'sw-visibility', // Built-in command
        }, {
            id: 'export',
            className: 'btn-open-export',
            label: '<img src="../Icons/download.svg" alt="">',
            command: 'export-template',
            context: 'export-template', // For grouping context of buttons from the same panel
        }, {
            id: 'show-json',
            className: 'btn-show-json',
            label: '<img src="../Icons/code.svg" alt="">',
            context: 'show-json',
            command(editor) {

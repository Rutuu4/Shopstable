<x-guest-layout>
    <div class="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8 ">
            ...
            <form class="mt-8 space-y-6" action="http://{{ request()->getHttpHost() }}/customer/login" method="POST">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        <a href="http://{{ request()->getHttpHost() }}/customer/register"
                            class="font-medium text-indigo-600 hover:text-indigo-500"> Sign up
                        </a>
            ...
            <script>
                ...
                console.log(localStorage.getItem('X-CSRF-TOKEN'), 'X-CSRF-TOKEN');
            </script>
        </div>
    </div>
</x-guest-layout>
